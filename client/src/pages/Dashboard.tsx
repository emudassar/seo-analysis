...
import { SearchIcon, ArrowRightIcon, BarChart3Icon, GlobeIcon, TrendingUpIcon, Users } from "lucide-react";
        ...
        <div className="min-h-screen pt-16 md:pt-24 bg-background">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
                ...
                <div className="mb-8">
                    ...
                    <p className="text-muted-foreground text-sm">Run AI-powered SEO audits and review your latest reports.</p>
                </div>

                {/* Quick Analyze */}
                <form onSubmit={handleAnalyze} className="mb-10">
                    <div className="border border-primary/25 rounded-2xl p-2 flex items-center gap-2 max-w-2xl bg-card">
                ...
                <Link
                    to="/compare"
                    className="mb-10 inline-flex items-center gap-2 px-4 py-2.5 rounded-xl border border-primary/25 bg-primary/5 text-sm text-primary hover:bg-primary/10 transition-colors"
                >
                    <Users size={18} />
                    Competitor Intelligence — compare up to 3 rivals
